        ...
        for batch_idx, sample in enumerate(TrainImgLoader):
            ...
            if (not is_distributed) or (dist.get_rank() == 0):
                if do_summary:
                    ...
                    print(
                        "Epoch {}/{}, Iter {}/{}, lr {:.6f}, train loss = {:.3f}, depth loss = {:.3f}, entropy loss = {:.3f}, edge loss = {:.3f},  epe = {:.3f}, less1 = {:.3f}, less3 = {:.3f}, time = {:.3f}".format(
            ...
            for batch_idx, sample in enumerate(TestImgLoader):
                ...
                if (not is_distributed) or (dist.get_rank() == 0):
                    if do_summary:
                        ...
                        print("Epoch {}/{}, Iter {}/{}, test loss = {:.3f}, depth loss = {:.3f}, entropy loss = {:.3f}, edge loss = {:.3f}, epe = {:.3f}, less1 = {:.3f}, less3 = {:.3f}, time = {:3f}".format(
...
def train_sample(model, model_loss, optimizer, sample, args):
    ...
    # 检查是否存在 'edges' 键
    if "edges" not in sample_cuda:
        raise KeyError("'edges' key not found in sample_cuda")
    ...
    try:
        ...
        total_loss, depth_loss, total_entropy, total_edge_loss, epe, less1, less3 = model_loss(
            outputs, depth_gt_ms, mask_ms, sample_cuda["depth_interval"],
